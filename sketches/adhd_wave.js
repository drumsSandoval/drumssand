...
function draw() {
    ...
    if (mode === 0) {
        ...
        cMain = color(20, 200);
        uiColor = color(0);
        statusText = "SYSTEM // ANXIETY_LEVEL_HIGH";
        ...
        cMain = color(255);
        uiColor = color(255);
        statusText = "FATAL_ERROR ☠️ GPU_DEAD";
        
        // Efecto extra: Barras negras de falla de hardware
        if (random(1) > 0.9) {
            fill(0);
    ...
    let noiseAmount = (mode === 3) ? 2000 : 800;
